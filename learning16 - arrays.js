//array - almost all days of week, we use push later in script to add more to the array
const daysOfWeek = [
    "monday",
    "tuesday",
    "wednesday",
...
//push function - adds value to end of array
...
//reverse function - reverse order of array
daysOfWeek.reverse()
console.log(daysOfWeek.join("|"))
